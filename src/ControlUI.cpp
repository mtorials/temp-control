...
ControlUI::ControlUI(Waveshare_ILI9486 *tft, TemperatureCore *core)
{
  ...
  // posY += size.y + offset;
  // posX = start.x;
  // buttons[3] = Button(tft, core, &currentlyEditing, valueGetter, {posX, posY}, size, [](Waveshare_ILI9486 * tft, ButtonContext ctx) {
  //   ctx.currentEdit->setValue(EditableValues::T1);
  // }, "T1", [](ButtonContext ctx) -> bool {
  //   return ctx.currentEdit->getValue() == EditableValues::T1;
  // });
  // posX += offset + size.x;
  // buttons[4] = Button(tft, core, &currentlyEditing, valueGetter, {posX, posY}, size, [](Waveshare_ILI9486 * tft, ButtonContext ctx) {
  //   ctx.currentEdit->setValue(EditableValues::T2);
  // }, "T2", [](ButtonContext ctx) -> bool {
  //   return ctx.currentEdit->getValue() == EditableValues::T2;
  // });
  // posX += offset + size.x;
  // buttons[5] = Button(tft, core, &currentlyEditing, valueGetter, {posX, posY}, size, [](Waveshare_ILI9486 * tft, ButtonContext ctx) {
  ...
  // posY += size.y + offset;
  // posX = start.x;
  // buttons[6] = Button(tft, core, &currentlyEditing, valueGetter, {posX, posY}, size, [](Waveshare_ILI9486 * tft, ButtonContext ctx) {
  ...
  // });
  // posX += offset + size.x;
  // buttons[7] = Button(tft, core, &currentlyEditing, valueGetter, {posX, posY}, size, [](Waveshare_ILI9486 * tft, ButtonContext ctx) {
  ...
  // });
  // posX += offset + size.x;
  // buttons[8] = Button(tft, core, &currentlyEditing, valueGetter, {posX, posY}, size, [](Waveshare_ILI9486 * tft, ButtonContext ctx) {
  ...
  // posX = start.x;
  // buttons[11] = Button(
  //     tft, core, &currentlyEditing, valueGetter, {posX, posY}, size, [](Waveshare_ILI9486 *tft, ButtonContext ctx)
  //     { ctx.core->start(); },
  //     "Start");
  // posX += offset + size.x;
  // buttons[12] = Button(
